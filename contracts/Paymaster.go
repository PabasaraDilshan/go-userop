...
// GameAccountFactory is a free data retrieval call binding the contract method 0x06ac9ec3.
//
// Solidity: function gameAccountFactory() view returns(address)
func (_Paymaster *PaymasterCaller) GameAccountFactory(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Paymaster.contract.Call(opts, &out, "gameAccountFactory")
...
//
// Solidity: function gameAccountFactory() view returns(address)
func (_Paymaster *PaymasterSession) GameAccountFactory() (common.Address, error) {
	return _Paymaster.Contract.GameAccountFactory(&_Paymaster.CallOpts)
}

// GameAccountFactory is a free data retrieval call binding the contract method 0x06ac9ec3.
//
// Solidity: function gameAccountFactory() view returns(address)
func (_Paymaster *PaymasterCallerSession) GameAccountFactory() (common.Address, error) {
	return _Paymaster.Contract.GameAccountFactory(&_Paymaster.CallOpts)
}
...
// GetHash is a free data retrieval call binding the contract method 0x7376c4de.
//
// Solidity: function getHash((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes) userOp, bool isPositive, uint32 amount, address tokenAddress, uint48 validUntil, uint48 validAfter) view returns(bytes32)
func (_Paymaster *PaymasterCaller) GetHash(opts *bind.CallOpts, userOp UserOperation, isPositive bool, amount uint32, tokenAddress common.Address, validUntil *big.Int, validAfter *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Paymaster.contract.Call(opts, &out, "getHash", userOp, isPositive, amount, tokenAddress, validUntil, validAfter)
...
//
// Solidity: function getHash((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes) userOp, bool isPositive, uint32 amount, address tokenAddress, uint48 validUntil, uint48 validAfter) view returns(bytes32)
func (_Paymaster *PaymasterSession) GetHash(userOp UserOperation, isPositive bool, amount uint32, tokenAddress common.Address, validUntil *big.Int, validAfter *big.Int) ([32]byte, error) {
	return _Paymaster.Contract.GetHash(&_Paymaster.CallOpts, userOp, isPositive, amount, tokenAddress, validUntil, validAfter)
}

// GetHash is a free data retrieval call binding the contract method 0x7376c4de.
//
// Solidity: function getHash((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes) userOp, bool isPositive, uint32 amount, address tokenAddress, uint48 validUntil, uint48 validAfter) view returns(bytes32)
func (_Paymaster *PaymasterCallerSession) GetHash(userOp UserOperation, isPositive bool, amount uint32, tokenAddress common.Address, validUntil *big.Int, validAfter *big.Int) ([32]byte, error) {
	return _Paymaster.Contract.GetHash(&_Paymaster.CallOpts, userOp, isPositive, amount, tokenAddress, validUntil, validAfter)
}
...
//
// Solidity: function parsePaymasterAndData(bytes paymasterAndData) pure returns(bool isPositive, uint32 amount, address tokenAddress, uint48 validUntil, uint48 validAfter, bytes signature)
func (_Paymaster *PaymasterCaller) ParsePaymasterAndData(opts *bind.CallOpts, paymasterAndData []byte) (struct {
	...
	outstruct.IsPositive = *abi.ConvertType(out[0], new(bool)).(*bool)
	...
	outstruct.ValidUntil = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.ValidAfter = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.Signature = *abi.ConvertType(out[5], new([]byte)).(*[]byte)
